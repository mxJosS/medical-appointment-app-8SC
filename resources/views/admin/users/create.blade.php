        ...
        <form action="{{route('admin.users.store')}}" method="POST">
            ...
            <div class="space-y-4">
                <div class="grid lg:grid-cols-2 gap-4">
                    ...
                    <x-wire-input label="Email" name="email" type="email" placeholder="Email" value="{{ old('email') }}">
                    </x-wire-input>
                    ...
                    <x-wire-input label="Número de ID" name="id_number" placeholder="Número de ID" value="{{ old('id_number') }}">
                    </x-wire-input>
                    
                    <x-wire-input label="Teléfono" name="phone" placeholder="Teléfono" autocomplete="tel" value="{{ old('phone') }}">
                    </x-wire-input>
                </div>

                <x-wire-input name="address" label="Dirección" required placeholder="Ej. Calle 90 293" autocomplete="street-address" value="{{ old('address') }}">
                </x-wire-input>
